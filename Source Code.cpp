...
void startGame(){
    ...
    //KIll check car1
    if((abs(lrIndex-lrIndex1)<8) && (car1+100<14)){
            if(powerbegin == -1){
              powerbegin = score;
            }
            else if(powerbegin + powercount < score){
              start = 0;
              gv=1;
            }
    }
    ...
    //KIll check car2
    if((abs(lrIndex-lrIndex2)<8) && (car2+100<14)){
            if(powerbegin == -1){
              powerbegin = score;
            }
            else if(powerbegin + powercount < score){
    ...
    //KIll check car3
    if((abs(lrIndex-lrIndex3)<8) && (car3+100<14)){
            if(powerbegin == -1){
              powerbegin = score;
            }
            else if(powerbegin + powercount < score){
...
void fristDesign(){
      ...
      //Text Information in Frist Page
        ...
        renderBitmapString(30-5,50-43,GLUT_BITMAP_8_BY_13,"Group 6");
}
